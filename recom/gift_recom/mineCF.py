        ...
        for user, movies in self.trainSet.items():
            for m1 in movies:
                for m2 in movies:
                    ...
                    # Item - CF
                    self.movie_sim_matrix[m1][m2] += self.trainSet[user]
    ...
    def evaluate(self):
        ...
        for i, user in enumerate(self.trainSet):
            if user in self.testSet.keys():
                ...
                rec_count += len(test_moives)
                pre_count += N
            else:
                continue
        print('hit:{}\tpre_count:{}\trec_count:{}'.format(hit, pre_count, rec_count))
